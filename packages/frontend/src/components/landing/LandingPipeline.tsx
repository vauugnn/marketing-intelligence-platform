...
export default function LandingPipeline() {
    // Hardcoded for landing page visualization
    const siteNode: PipelineNode = {
        id: 'ecommerce', label: 'Your Store', x: 6, y: 50, color: '#10b981',
    };
    ...
    const platformDefs = [
        { id: 'ga4', label: 'Google Analytics', color: '#10b981' },
        { id: 'meta', label: 'Meta', color: '#3b82f6' },
        { id: 'payment_systems', label: 'Payment Systems', color: '#6366f1' },
        { id: 'hubspot', label: 'Email Systems', color: '#f97316' },
    ];
    ...
    const insightNodes: PipelineNode[] = [
        { id: 'performance', label: 'Performance', x: 97, y: 22, color: '#10b981' },
        { id: 'synergy', label: 'Synergies', x: 97, y: 50, color: '#3b82f6' },
        { id: 'recommendations', label: 'AI Actions', x: 97, y: 78, color: '#f59e0b' },
    ];

    return (
        <div className="w-full h-full relative" style={{ minHeight: '380px' }}>
            <svg className="w-full h-full" viewBox="-5 0 120 100" preserveAspectRatio="xMidYMid meet">
                <defs>
                ...
                {/* ---- Animated dots (removed hover effects) ---- */}
                ...
                <g>
                    ...
                    <text x={siteNode.x} y={siteNode.y + 8.5} fill="#d1d5db" fontSize="2" fontWeight="600" textAnchor="middle">Your Store</text>
                </g>

                {/* ---- Tracking Pixel node (static, no hover) ---- */}
                <g>
                ...
                {/* ---- Platform verification icons (static, no hover) ---- */}
                ...
                {/* ---- Attribution Engine node (static, no hover) ---- */}
                <g>
                ...
                {/* ---- Insight output nodes (static, no hover) ---- */}
