...
const CHANNEL_POSITIONS: Record<string, { desktop: { x: number; y: number }; mobile: { x: number; y: number } }> = {
  facebook: { desktop: { x: 28, y: 45 }, mobile: { x: 22, y: 45 } },
  google: { desktop: { x: 72, y: 45 }, mobile: { x: 78, y: 45 } },
  instagram: { desktop: { x: 50, y: 20 }, mobile: { x: 50, y: 18 } },
  email: { desktop: { x: 50, y: 70 }, mobile: { x: 50, y: 72 } },
