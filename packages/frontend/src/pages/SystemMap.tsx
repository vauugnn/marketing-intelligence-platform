            ...
            <div className={`border-t border-gray-800 p-3 sm:p-6 bg-gray-900/50 ${selectedNode ? 'hidden lg:block' : 'block'}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                <div className="flex items-start">
                  ...
                  <div><p className="text-white font-semibold">Green solid</p><p className="text-gray-400 text-xs">Strong synergy (score &ge; 1.5)</p></div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 sm:w-12 h-1 bg-yellow-500 mr-2 sm:mr-3 mt-1.5 sm:mt-2 flex-shrink-0 rounded"></div>
                  <div><p className="text-white font-semibold">Yellow solid</p><p className="text-gray-400 text-xs">Some reinforcement (score &ge; 1.0)</p></div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 sm:w-12 h-1 bg-red-500 mr-2 sm:mr-3 mt-1.5 sm:mt-2 flex-shrink-0 rounded"></div>
                  <div><p className="text-white font-semibold">Red solid</p><p className="text-gray-400 text-xs">Weak connection</p></div>
                </div>
                <div className="flex items-start">
                  ...
                  <div><p className="text-white font-semibold">Node size</p><p className="text-gray-400 text-xs">Revenue volume indicator</p></div>
                </div>
              </div>
              <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-800">
                <p className="text-xs text-gray-500">Click on nodes to see detailed information and relationships.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex items-start justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-base sm:text-xl text-white">{getNodeDetails(selectedNode).node?.name}</h3>
                ...
                {getNodeDetails(selectedNode).channel ? (
                    ...
                    <div className="bg-gray-800/50 rounded-lg p-3 sm:p-4 border border-gray-700">
                      ...
                      <div className="space-y-3">
                            ...
                            <div key={idx} className="bg-gray-900/50 p-3 rounded border border-gray-700/50">
                              <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-1 flex-1 text-xs sm:text-sm">
                                  <span className="text-gray-300 font-medium truncate">{getNodeNameById(conn.fromNode)}</span>
                                  ...
                                  <span className="text-gray-300 font-medium truncate">{getNodeNameById(conn.toNode)}</span>
                                </div>
                              ...
                              <div className="grid grid-cols-3 gap-2 mt-2 pt-2 border-t border-gray-700/50">
                                <div>
                                  <div className="text-xs text-gray-500 mb-0.5">Synergy</div>
                                  <div className="text-sm font-bold text-white">{metrics.score}x</div>
                                </div>
                                <div>
                                  <div className="text-xs text-gray-500 mb-0.5">Frequency</div>
                                  <div className="text-sm font-bold text-blue-400">{metrics.frequency}</div>
                                </div>
                                <div>
                                  <div className="text-xs text-gray-500 mb-0.5">Confidence</div>
                                  <div className="text-sm font-bold text-green-400">{metrics.confidence}%</div>
                                </div>
                              </div>
                            </div>
                          );
                        ...
                        {getNodeConnections(selectedNode).length === 0 && (
                          <p className="text-xs text-gray-500">No synergy connections found for this channel.</p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-800/50 rounded-lg p-6 text-center border border-gray-700">
                    <div className="text-gray-400 text-sm">No detailed metrics available for this platform yet.</div>
                  </div>
                )}
              </div>
            </div>
